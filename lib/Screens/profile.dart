...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    vehicleC = new TextEditingController();
    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          print(data);
          vehicleC!.text = data['vehicle_no'].toString();
            ...
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    vehicleC!.text == null || vehicleC!.text == ""
                        ? Text("")
                        : Text(
                            vehicleC!.text,
                            style: Theme.of(this.context)
            ...
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addressResult == null || addressResult == ""
                        ? Text("")
                        : Container(
