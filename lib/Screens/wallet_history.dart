...
class StateWallet extends State<WalletHistory> with TickerProviderStateMixin {
  ...
  listItem(int index) {
    Color back;
    if (tranList[index].status == "success" || tranList[index].status == "1") {
      back = Colors.green;
    } else if (tranList[index].status == "0")
      back = Colors.orange;
    else
      back = Colors.red;
    return Card(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Text(
                            tranList[index].status == "0"
                                ? "Pending"
                                : tranList[index].status == "1"
                                ? "Approved"
                                : "Rejected",
